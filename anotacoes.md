...
* Fazer nosso deploy = colcoar nossa aplicação online
    ...
    * Vá até seu GitHub > criar novo repositório > adicionar um nome "curso-de-react-yt" > como público > copiar as 3 linhas de baixo `... or push an exisiting repository from the command line`, sendo uma por uma.
    * Recarregando seu projeto deve estar lá no GitHub. Se não estiver é porque fez algo errado.
    * Adicionando o projeto ao Vercel.
